...
#[ORM\Entity(repositoryClass: PrimaryCreatorRepository::class)]
class PrimaryCreator
{
    ...
    #[ORM\ManyToMany(targetEntity: Catalogue::class, mappedBy: 'primary_creator')]
    ...
    public function addCatalogue(Catalogue $catalogue): self
    {
        if (!$this->catalogues->contains($catalogue)) {
            ...
            $catalogue->addPrimaryCreator($this);
        }
    ...
    public function removeCatalogue(Catalogue $catalogue): self
    {
        if ($this->catalogues->removeElement($catalogue)) {
            $catalogue->removePrimaryCreator($this);
        }
